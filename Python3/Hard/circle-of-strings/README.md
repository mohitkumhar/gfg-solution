<h2><a href="https://www.geeksforgeeks.org/problems/circle-of-strings4530/1">Circle of Strings</a></h2><h3>Hard</h3><hr><p><span style="font-size: 18px;">Given an array <strong>arr </strong>of lowercase strings, find if the strings can be chained together to form a circle.</span></p>
<ul>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong>&nbsp;<br>1 ≤ arr.size() ≤ 10^4<br></span><span style="font-size: 18px;">1 ≤ length of strings ≤ 20</span></p>