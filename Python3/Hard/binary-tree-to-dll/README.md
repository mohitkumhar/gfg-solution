<h2><a href="https://www.geeksforgeeks.org/problems/binary-tree-to-dll/1">Binary Tree to DLL</a></h2><h3>Hard</h3><hr><p dir="ltr"><span style="font-size: 14pt;">Given the <strong>root </strong>of a binary tree, convert it to a Doubly Linked List (DLL) in place, using the same node structure.</span></p>
<ul>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ number of nodes ≤ 10<sup>6</sup><br>0 ≤ node-&gt;data ≤ 10<sup>5</sup></span></p>