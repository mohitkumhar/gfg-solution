<h2><a href="https://www.geeksforgeeks.org/problems/search-pattern-rabin-karp-algorithm--141631/1">Search Pattern (Rabin-Karp Algorithm)</a></h2><h3>Hard</h3><hr><p data-start="374" data-end="392"><span style="font-size: 14pt;">Given two strings:</span></p>
...
<p><span style="font-size: 18px;"><strong style="font-size: 18px;">Constraints:</strong><br><span style="font-size: 18px;">1 ≤ text.size() ≤ 10<sup>6</sup></span><br><span style="font-size: 18px;">1 ≤ pattern.size() ≤ text.size()</span><br><span style="font-size: 18px;">Both the strings consist of lowercase English alphabets.</span></span></p>