...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ n ≤ 500, where n is the length of words.<br>1 ≤ m ≤ 10, where m is the length of words[i]<br>The sum of all shortest sequences does not exceed<span style="font-size: 14pt;"> 10<sup>5</sup>.&nbsp;<sup><br><span style="font-size: 14pt;">Let k is the number of shortest transformation sequences.</span></sup></span></span></p>