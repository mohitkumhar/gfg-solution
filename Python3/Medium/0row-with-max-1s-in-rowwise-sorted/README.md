...
<li><span style="font-size: 14pt;">The number of rows and columns in the array are denoted by <code>n</code>.</span></li>
</ul>
<p><span style="font-size: 14pt;"><strong>Examples:</strong></span></p>
<pre><span style="font-size: 14pt;"><strong>Input: </strong>arr[][] = [[0,1,1,1],<br>               [0,0,1,1],<br>               [1,1,1,1],<br>               [0,0,0,0]]
...
<pre><span style="font-size: 14pt;"><strong>Input: </strong>arr[][] = [[0,0],<br>               [1,1]]
...
<pre><span style="font-size: 14pt;"><strong>Input: </strong>arr[][] = [[0,0], <br>               [0,0]]
<strong>Output:</strong> -1
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 ≤ arr.size(), arr[i].size()&nbsp;≤ 10<sup>3</sup><br></span></p>