<h2><a href="https://www.geeksforgeeks.org/problems/inversion-of-array-1587115620/1">Count Inversions</a></h2><h3>Medium</h3><hr><p><span style="font-size: 14pt;">Given an array of integers <strong>arr[]</strong>. You have to find the<strong> </strong>Inversion Count of the array. I</span><span style="font-size: 14pt;">nversion count is the number of pairs of elements (i, j) such that i &lt; j and arr[i] &gt; arr[j].</span></p>
