...
<pre><span style="font-size: 18px;"><span style="font-size: 18px;"><strong>Input:</strong> n = 4, m = 16
<strong>Output:</strong> 2
<strong>Explanation:</strong> 2<sup>4</sup> = 16</span></span></pre>
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ n ≤ 9</span><br><span style="font-size: 18px;">0 ≤ m ≤ 20</span></p>